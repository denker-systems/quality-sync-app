          ...
          <View style={styles.languageToggleContainer}>
            <TouchableOpacity
              style={[
                ...
                {
                  backgroundColor:
                    language === 'sv' ? (isDark ? '#2A2A2A' : '#E8E8E8') : 'transparent',
                },
              ]}
            ...
            <TouchableOpacity
              style={[
                ...
                {
                  backgroundColor:
                    language === 'en' ? (isDark ? '#2A2A2A' : '#E8E8E8') : 'transparent',
                },
              ]}
        ...
        <AnimatedEntrance preset="fadeInUp" delay={STAGGER_DELAYS.medium * 2}>
          <Card variant="elevated" style={styles.card}>
            <CardContent>
              ...
              <Text variant="body-sm" style={[styles.label, { color: mutedColor, marginTop: 16 }]}>
                {t('auth.password')}
              </Text>
              <Controller
                control={control}
