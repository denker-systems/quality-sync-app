...
export function OnboardingPathNode({ status, accentColor, image }: OnboardingPathNodeProps) {
  ...
  return (
    <MotiView
      ...
      transition={isActive ? { type: 'timing', duration: 1200, loop: true } : { type: 'timing', duration: 200 }}
    >
      {image ? (
